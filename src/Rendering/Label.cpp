...
void Label::Create()
{
	...
	Text2DUniformID = glGetUniformLocation(program, "myTextureSampler");
}
...
GLuint Label::LoadDDS(const char * imagepath) {
...
GLuint Label::GetVao() const
{
	return vao;
}

const std::vector<GLuint>& Label::GetVbos() const
{
	return vbos;
}